            ...
            <div class="container mx-auto flex justify-between items-center"> 
                ...
                <nav class="flex gap-2 items-center">
                    @auth
                        ...
                        <a href="{{ route('posts.create') }}" class="flex items center gap-2 bg-white border p-2 text-gray-600 rounded text-sm cursor-pointer uppercase">
                        ...
                        <a href="/{{ auth() -> user() -> username }}" class="font-bold text-gray-600 text-sm mx-5">Hola <span class="font-normal">{{ auth() -> user() -> username }}</span></a>
